...
image11 = Image.create(url: "https://scontent-lax3-1.xx.fbcdn.net/v/t1.0-9/68690757_10220132410879867_4306520281284870144_n.jpg?_nc_cat=109&_nc_sid=8bfeb9&_nc_oc=AQmaXdRY5J8iAFt72_N8Ry4Wj-dcgWod4kgeTTpWhIvlAN4_nI3FqEUqWAwRBIqopFssAaW1VGZdn92HEU8pmHZX&_nc_ht=scontent-lax3-1.xx&oh=9c5b263581cfda6602f781cb194987dd&oe=5F0E8838", image_type: "image", user: patty, fridge: fridge4, name: "Grandma", description: "Look at me im going to be a granny!")



comment1 = Comment.create(comment_info: "Comment 1", user: user4, image: image10)
comment2 = Comment.create(comment_info: "Comment 2", user: user4, image: image5)
comment3 = Comment.create(comment_info: "Comment 3", user: shannon, image: image7)
comment4 = Comment.create(comment_info: "Comment 4", user: user4, image: image7)
comment5 = Comment.create(comment_info: "Comment 5", user: amber, image: image7)
comment6 = Comment.create(comment_info: "Comment 6", user: user4, image: image6)
comment7 = Comment.create(comment_info: "Comment 7", user: shannon, image: image11)
comment8 = Comment.create(comment_info: "Comment 8", user: user4, image: image9)